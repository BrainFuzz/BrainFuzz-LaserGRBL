...
namespace LaserGRBL {
  public enum Firmware { Grbl, Smoothie, Marlin, VigoWork }
  ...
  public class GrblCore {
	...
	public class ThreadingMode {
	  ...
	  public static ThreadingMode Slow { get { return new ThreadingMode(2000, 15, 4, 2, 1, "Slow"); } }

	  public static ThreadingMode Quiet { get { return new ThreadingMode(1000, 10, 2, 1, 1, "Quiet"); } }

	  public static ThreadingMode Fast { get { return new ThreadingMode(500, 5, 1, 1, 0, "Fast"); } }

	  public static ThreadingMode UltraFast { get { return new ThreadingMode(200, 1, 0, 0, 0, "UltraFast"); } }

	  public static ThreadingMode Insane { get { return new ThreadingMode(100, 1, 0, 0, 0, "Insane"); } }

	  public override string ToString() { return Name; }

	  public override bool Equals(object obj) { return obj != null && obj is ThreadingMode && ((ThreadingMode) obj).Name == Name; }
	...
	public enum MacStatus { Disconnected, Connecting, Idle, Run, Hold, Door, Home, Alarm, Check, Jog, Queue, Cooling }

	public enum JogDirection { None, Abort, Home, N, S, W, E, NW, NE, SW, SE, Zup, Zdown }
	...
	public class GrblVersionInfo :IComparable, ICloneable {
	  ...
	  public GrblVersionInfo(int major, int minor, char build) { mMajor = major; mMinor = minor; mBuild = build; }

	  public GrblVersionInfo(int major, int minor) { mMajor = major; mMinor = minor; mBuild = (char) 0; }

	  public static bool operator !=(GrblVersionInfo a, GrblVersionInfo b) { return !(a == b); }
	  ...
	  public static bool operator >(GrblVersionInfo a, GrblVersionInfo b) { return (b < a); }
	  ...
	  public int OrturFWVersionNumber {
		get {
		  try { return int.Parse(mVendorVersion); } catch { return -1; }
		}
	  }
	}
	...
	public GrblCore(System.Windows.Forms.Control syncroObject, PreviewForm cbform, JogForm jogform) {
	  ...
	  if (!Settings.ExistObject("Hotkey Setup"))
		Settings.SetObject("Hotkey Setup", new HotKeysManager());
	...
	public virtual Firmware Type { get { return Firmware.Grbl; } }
	...
	private void RefreshConfigOnConnect() {
	  try { System.Threading.ThreadPool.QueueUserWorkItem(new System.Threading.WaitCallback(RefreshConfigOnConnect)); } catch { }
	}
	...
	public GrblFile LoadedFile { get { return file; } }
	  ...
	  try {
		...
		if (filename != null) {
		  ...
		  if (ImageExtensions.Contains(System.IO.Path.GetExtension(filename).ToLowerInvariant())) //import raster image
		  {
			...
			} catch (Exception ex) { Logger.LogException("RasterImport", ex); }
			...
			if (mode == SvgConverter.SvgModeForm.Mode.Vector) {
			  ...
			  } catch (Exception ex) { Logger.LogException("SvgImport", ex); }
			  ...
			  try {
				...
				if (System.IO.File.Exists(bmpname))
				  System.IO.File.Delete(bmpname);
			  } catch (Exception ex) { Logger.LogException("SvgBmpImport", ex); }
			}
		...
		try {
		  ...
		  if (cmd.Status == GrblCommand.CommandStatus.ResponseGood) {
			...
			while (mSentPtr.Count < target && Tools.HiResTimer.TotalMilliseconds - tLast < 500 && Tools.HiResTimer.TotalMilliseconds - tStart < 5000) {
			  if (mSentPtr.Count != counter) { tLast = Tools.HiResTimer.TotalMilliseconds; counter = mSentPtr.Count; } else
				System.Threading.Thread.Sleep(10);
			}
	...
	public class WriteConfigException :Exception {
	  ...
	  public System.Collections.Generic.List<IGrblRow> Errors { get { return ErrorLines; } }
	}
	...
	public bool HasProgram { get { return file != null && file.Count > 0; } }

	public void EnqueueCommand(GrblCommand cmd) {
	  lock (this) { mQueuePtr.Enqueue(cmd.Clone() as GrblCommand); }
	}
	...
	public void CloseCom(bool user) {
	  ...
	  try {
		...
		lock (this) { ClearQueue(false); } //non resettare l'elenco delle cose mandate così da non sbiancare la lista
	...
	public void SafetyDoor() { SendImmediate(64); }

	// GRBL & smoothie : Send "?" to retrieve position
	// MarlinCore : Override : Send "M114\n"
	protected virtual void QueryPosition() { SendImmediate(63, true); }
	...
	public virtual void SendImmediate(byte b, bool mute = false) {
	  try {
		...
		lock (this) { if (com.IsOpen) com.Write(b); }
	  } catch (Exception ex) { Logger.LogException("SendImmediate", ex); }
	}
	...
	public int ProgramTarget { get { return mTP.Target; } }

	public int ProgramSent { get { return mTP.Sent; } }

	public int ProgramExecuted { get { return mTP.Executed; } }

	public TimeSpan ProgramTime { get { return mTP.TotalJobTime; } }

	public TimeSpan ProjectedTime { get { return mTP.ProjectedTarget; } }

	public MacStatus MachineStatus { get { return mMachineStatus; } }

	public bool InProgram { get { return mTP.InProgram; } }

	public GPoint MachinePosition { get { return mMPos; } }

	public GPoint WorkPosition //WCO = MPos - WPos
	{ get { return mMPos - mWCO; } }

	public GPoint WorkingOffset { get { return mWCO; } }

	public int Executed { get { return mSent.Count; } }
	...
	public bool SupportRTO { get { return GrblVersion != null && GrblVersion >= new GrblVersionInfo(1, 1); } }

	public virtual bool SupportTrueJogging { get { return GrblVersion != null && GrblVersion >= new GrblVersionInfo(1, 1); } }

	public bool SupportCSV { get { return GrblVersion != null && GrblVersion >= new GrblVersionInfo(1, 1); } }

	public bool SupportOverride { get { return GrblVersion != null && GrblVersion >= new GrblVersionInfo(1, 1); } }

	public bool SupportLaserMode { get { return GrblVersion != null && GrblVersion >= new GrblVersionInfo(1, 1); } }
	...
	protected void ThreadTX() {
	  lock (this) {
		...
		} catch (Exception ex) { Logger.LogException("ThreadTX", ex); }
	  }
	}
	...
	protected virtual bool HasSpaceInBuffer(GrblCommand command) { return (mUsedBuffer + command.SerialData.Length) <= BufferSize; }
	...
	private void SendLine() {
	  ...
	  if (tosend != null) {
		try {
		  ...
		  if (tosend != null)
			Logger.LogMessage("SendLine", "Error sending [{0}] command: {1}", tosend.Command, ex.Message);
	...
	public int UsedBuffer { get { return mUsedBuffer; } }

	public int FreeBuffer { get { return BufferSize - mUsedBuffer; } }

	public virtual int BufferSize { get { return mAutoBufferSize; } }

	public int GrblBlock { get { return mGrblBlocks; } }

	public int GrblBuffer { get { return mGrblBuffer; } }
	...
	void ThreadRX() {
	  ...
	  } catch (Exception ex) { Logger.LogException("ThreadRX", ex); }
	}
	...
	private void ManageGenericMessage(string rline) {
	  try { mSentPtr.Add(new GrblMessage(rline, SupportCSV)); } catch (Exception ex) {
	...
	public int OverrideG1 { get { return mCurOvLinear; } }

	public int OverrideG0 { get { return mCurOvRapids; } }

	public int OverrideS { get { return mCurOvPower; } }
	...
	protected virtual void ParseMachineStatus(string data) {
	  ...
	  try { var = (MacStatus) Enum.Parse(typeof(MacStatus), data); } catch (Exception ex) { Logger.LogException("ParseMachineStatus", ex); }
	...
	private bool InPause { get { return mMachineStatus != MacStatus.Run && mMachineStatus != MacStatus.Idle; } }
	...
	public bool CanLoadNewFile { get { return !InProgram; } }

	public bool CanSendFile { get { return IsConnected && HasProgram && IdleOrCheck; } }

	public bool CanAbortProgram { get { return IsConnected && HasProgram && (MachineStatus == MacStatus.Run || MachineStatus == MacStatus.Hold || MachineStatus == MacStatus.Cooling); } }

	public bool CanImportExport { get { return IsConnected && MachineStatus == MacStatus.Idle; } }

	public bool CanResetGrbl { get { return IsConnected && MachineStatus != MacStatus.Disconnected; } }

	public bool CanSendManualCommand { get { return IsConnected && MachineStatus != MacStatus.Disconnected && !InProgram; } }

	public bool CanDoHoming { get { return IsConnected && (MachineStatus == MacStatus.Idle || MachineStatus == GrblCore.MacStatus.Alarm) && Configuration.HomingEnabled; } }

	public bool CanDoZeroing { get { return IsConnected && MachineStatus == MacStatus.Idle && WorkPosition != GPoint.Zero; } }

	public bool CanUnlock { get { return IsConnected && (MachineStatus == MacStatus.Idle || MachineStatus == GrblCore.MacStatus.Alarm); } }

	public bool CanFeedHold { get { return IsConnected && MachineStatus == MacStatus.Run; } }

	public bool CanResumeHold { get { return IsConnected && (MachineStatus == MacStatus.Door || MachineStatus == MacStatus.Hold || MachineStatus == MacStatus.Cooling); } }

	public bool CanReadWriteConfig { get { return IsConnected && !InProgram && (MachineStatus == MacStatus.Idle || MachineStatus == MacStatus.Alarm); } }

	public decimal LoopCount { get { return mLoopCount; } set { mLoopCount = value; if (OnLoopCountChange != null) OnLoopCountChange(mLoopCount); } }

	private ThreadingMode CurrentThreadingMode { get { return Settings.GetObject("Threading Mode", ThreadingMode.UltraFast); } }

	public virtual StreamingMode CurrentStreamingMode { get { return Settings.GetObject("Streaming Mode", StreamingMode.Buffered); } }

	private bool IdleOrCheck { get { return MachineStatus == MacStatus.Idle || MachineStatus == MacStatus.Check; } }

	public bool AutoCooling { get { return Settings.GetObject("AutoCooling", false) && SupportAutoCooling; } }
	...
	public TimeSpan AutoCoolingOn { get { return Settings.GetObject("AutoCooling TOn", TimeSpan.FromMinutes(10)); } }

	public TimeSpan AutoCoolingOff { get { return Settings.GetObject("AutoCooling TOff", TimeSpan.FromMinutes(1)); } }
	...
	internal void HelpOnLine() { Tools.Utils.OpenLink(@"https://lasergrbl.com/usage/"); }

	internal void GrblHoming() { if (CanDoHoming) EnqueueCommand(new GrblCommand("$H")); }

	internal void GrblUnlock() { if (CanUnlock) EnqueueCommand(new GrblCommand("$X")); }

	internal void SetNewZero() { if (CanDoZeroing) EnqueueCommand(new GrblCommand("G92 X0 Y0 Z0")); }
	  ...
	  foreach (string str in arr) {
		if (str.Trim().Length > 0) {
		  ...
		  if (IsImmediate(tosend)) {
			...
			if (b == '!')
			  mHoldByUserRequest = true;
			SendImmediate(b);
		  } else { EnqueueCommand(new GrblCommand(tosend)); }
		}
	  }
	}
	...
	static string FormatNumber(decimal value) { return string.Format(System.Globalization.CultureInfo.InvariantCulture, "{0:0.000}", value); }
  ...
  public class TimeProjection {
	...
	public TimeSpan EstimatedTarget { get { return mETarget; } }

	public bool InProgram { get { return mStarted && !mCompleted; } }

	public int Target { get { return mTargetCount; } }

	public int Sent { get { return mSentCount - mContinueCorrection; } }

	public int Executed { get { return mExecutedCount - mContinueCorrection; } }
	...
	private TimeSpan TrueJobTime { get { return TotalJobTime - TotalJobPauses; } }
    ...
    #endregion === JOB HANDLING ===

    public void JobIssue(GrblCore.DetectedIssue issue) { mLastIssue = issue; }

	private long now { get { return Tools.HiResTimer.TotalMilliseconds; } }

	public int ErrorCount { get { return mErrorCount; } }

	public GrblCore.DetectedIssue LastIssue { get { return mLastIssue; } }
  }
  ...
  public class GrblConf :IEnumerable<System.Collections.Generic.KeyValuePair<int, decimal>> {
	public class GrblConfParam :ICloneable {
	  ...
	  public GrblConfParam(int number, decimal value) { mNumber = number; mValue = value; }

	  public int Number { get { return mNumber; } }

	  public string DollarNumber { get { return "$" + mNumber.ToString(); } }

	  public string Parameter { get { return CSVD.settings.GetItem(mNumber.ToString(), 0); } }
	  ...
	  public string Unit { get { return CSVD.settings.GetItem(mNumber.ToString(), 1); } }

	  public string Description { get { return CSVD.settings.GetItem(mNumber.ToString(), 2); } }
	...
	public GrblConf() { mData = new System.Collections.Generic.Dictionary<int, decimal>(); }
	...
	public static bool IsSetConf(string p) { return ConfRegEX.IsMatch(p); }
  ...
  public struct GPoint {
	...
	public static bool operator ==(GPoint a, GPoint b) { return a.X == b.X && a.Y == b.Y && a.Z == b.Z; }

	public static bool operator !=(GPoint a, GPoint b) { return !(a == b); }

	public static GPoint operator -(GPoint a, GPoint b) { return new GPoint(a.X - b.X, a.Y - b.Y, a.Z - b.Z); }
